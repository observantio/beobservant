...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"MAX_API_KEYS_PER_USER": "0"}, "MAX_API_KEYS_PER_USER must be greater than 0"),
        ({"QUOTA_NATIVE_TIMEOUT_SECONDS": "0"}, "QUOTA_NATIVE_TIMEOUT_SECONDS must be greater than 0"),
        ({"QUOTA_PROMETHEUS_TIMEOUT_SECONDS": "0"}, "QUOTA_PROMETHEUS_TIMEOUT_SECONDS must be greater than 0"),
        ({"QUOTA_USAGE_WINDOW_SECONDS": "0"}, "QUOTA_USAGE_WINDOW_SECONDS must be greater than 0"),
