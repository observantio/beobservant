...
def _seed(db):
    ...
    key_owned = UserApiKey(
        id="k1", tenant_id="t1", user_id="u1", name="owned", key="scope-owned", is_enabled=False, is_default=False
    )
    key_shared = UserApiKey(
        id="k2", tenant_id="t1", user_id="u1", name="shared", key="scope-shared", is_enabled=False, is_default=False
    )
    key_foreign = UserApiKey(
        id="k3", tenant_id="t2", user_id="u4", name="foreign", key="scope-collide", is_enabled=True, is_default=False
    )
    share = ApiKeyShare(id="s1", tenant_id="t1", api_key_id="k2", owner_user_id="u1", shared_user_id="u2", can_use=True)
    ds_private = GrafanaDatasource(
        id="d1",
        tenant_id="t1",
        created_by="u1",
        grafana_uid="uid-private",
        grafana_id=11,
        name="Private",
        type="prometheus",
        visibility="private",
    ...
    ds_group = GrafanaDatasource(
        id="d2",
        tenant_id="t1",
        created_by="u1",
        grafana_uid="uid-group",
        grafana_id=12,
        name="Grouped",
        type="loki",
        visibility="group",
    ...
    ds_tenant = GrafanaDatasource(
        id="d3",
        tenant_id="t1",
        created_by="u1",
        grafana_uid="uid-tenant",
        grafana_id=13,
        name="TenantWide",
        type="tempo",
        visibility="tenant",
...
def test_datasource_helper_functions(monkeypatch):
    ...
    assert (
        datasource_ops._sanitize_datasource_payload(
            {"password": "p", "basicAuthPassword": "b", "secureJsonData": {"x": 1}}, is_owner=False
        )["password"]
        is None
    )
...
def test_get_datasources_filters_hidden_for_current_user():
    ...
    stub.items = {
        "uid-group": FakeGrafanaDatasource(
            id=12,
            uid="uid-group",
            name="Grouped",
            type="loki",
        ...
        "uid-tenant": FakeGrafanaDatasource(
            id=13,
            uid="uid-tenant",
            name="TenantWide",
            type="tempo",
...
def test_enforce_query_access_and_read_paths():
    ...
    stub.items = {
        ...
        "uid-system": FakeGrafanaDatasource(
            id=14,
            uid="uid-system",
            name="System",
            type="prometheus",
...
def test_create_update_and_delete_datasource_branches(monkeypatch):
    ...
    stub.items["uid-created"] = FakeGrafanaDatasource(
        id=101,
        uid="uid-created",
        name="Metrics",
        type="prometheus",
