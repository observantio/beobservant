...
class Folder(BaseModel):
    ...
    uid: str | None = Field(None, description="Unique identifier string for the folder")
    title: str = Field(..., description="Title of the folder")
    version: int | None = Field(None, description="Current folder version")
    created_by: str | None = Field(None, description="ID of the user who created the folder")
