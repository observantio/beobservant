...
class DashboardMeta(BaseModel):
    ...
    slug: str | None = Field(None, description="URL slug of the dashboard")
    folder: int | None = Field(None, description="Folder ID containing the dashboard")
    url: str | None = Field(None, description="URL of the dashboard")
    version: int | None = Field(None, description="Version number of the dashboard")
    model_config = ConfigDict(populate_by_name=True)


class Dashboard(BaseModel):
    id: int | None = Field(None, description="Unique identifier for the dashboard")
    uid: str | None = Field(None, description="Unique identifier string for the dashboard")
    ...
    version: int | None = Field(None, description="Version number of the dashboard")
    refresh: str | None = Field(None, description="Auto-refresh interval")
    panels: list[JSONDict] | None = Field(default_factory=list, description="List of panels in the dashboard")
    templating: JSONDict | None = Field(None, description="Template variables configuration")
    time: JSONDict | None = Field(None, description="Time range configuration")
    time_picker: JSONDict | None = Field(None, alias="timePicker", description="Time picker configuration")
...
class DashboardCreate(BaseModel):
    ...
    message: str | None = Field(None, description="Commit message for the dashboard creation")
    model_config = ConfigDict(populate_by_name=True)


class DashboardUpdate(BaseModel):
    dashboard: Dashboard = Field(..., description="Updated dashboard configuration")
    folder_id: int | None = Field(None, alias="folderId", description="ID of the folder containing the dashboard")
    overwrite: bool = Field(True, description="Whether to overwrite existing dashboard")
    message: str | None = Field(None, description="Commit message for the dashboard update")
    model_config = ConfigDict(populate_by_name=True)
...
class DashboardSearchResult(BaseModel):
    ...
    tags: list[str] = Field(default_factory=list, description="Tags associated with the dashboard")
    is_starred: bool = Field(False, alias="isStarred", description="Whether the dashboard is starred")
    folder_id: int | None = Field(None, alias="folderId", description="ID of the containing folder")
    folder_uid: str | None = Field(None, alias="folderUid", description="UID of the containing folder")
    folder_title: str | None = Field(None, alias="folderTitle", description="Title of the containing folder")
    created_by: str | None = Field(None, description="ID of the user who registered/created the dashboard")
