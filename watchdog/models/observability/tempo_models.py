...
class Span(BaseModel):
    ...
    parent_span_id: Optional[str] = Field(
        None, alias="parentSpanID", description="Parent span ID if this is a child span"
    )
...
class Trace(BaseModel):
    ...
    processes: Optional[JSONDict] = Field(
        default_factory=dict, description="Process information for spans in this trace"
    )
