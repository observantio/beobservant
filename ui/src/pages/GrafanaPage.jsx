...
function GrafanaTabs({ activeTab, onChange }) {
  const tabs = [
...
function DashboardsTab({ dashboards, query, setQuery, onSearch, openDashboardEditor, onOpenGrafana, onDeleteDashboard }) {
  return (
    <>
...
function DatasourcesTab({ datasources, openDatasourceEditor, onDeleteDatasource, getDatasourceIcon }) {
  return (
    <>
...
function FoldersTab({ folders, onCreateFolder, onDeleteFolder }) {
  return (
    <>
      <div className="mb-6 flex justify-end">
...
function GrafanaContent({ loading, activeTab, dashboards, datasources, folders, query, setQuery, onSearch, openDashboardEditor, onOpenGrafana, onDeleteDashboard, openDatasourceEditor, onDeleteDatasource, getDatasourceIcon, onCreateFolder, onDeleteFolder }) {
  if (loading) {
    return (
      <div className="py-12">
        <Spinner size="lg" />
