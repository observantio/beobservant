    ...
    const traces = [
      {
        traceID: 't1',
        spans: [
          { spanId: '1', serviceName: 'api', duration: 200000, status: { code: 'OK' } },
          { spanId: '2', parentSpanId: '1', serviceName: 'db', duration: 500000, status: { code: 'ERROR' } },
        ],
      },
    ]
    ...
    const graphData = buildServiceGraphData([
      {
        traceID: 't1',
        spans: [
          { spanId: '1', serviceName: 'api', duration: 1000, status: { code: 'OK' } },
          { spanId: '2', parentSpanId: '1', serviceName: 'db', duration: 2000, status: { code: 'OK' } },
        ],
      },
    ])
