...
describe('alertmanagerChannelUtils', () => {
  ...
  it('reads default metric order on invalid storage payload', () => {
    ...
    expect(readMetricOrderFromStorage(storage)).toEqual(DEFAULT_ALERTMANAGER_METRIC_KEYS)
  })
  ...
  it('writes metric order safely', () => {
    ...
    writeMetricOrderToStorage(['channels', 'silences', 'activeAlerts', 'alertRules'], storage)
