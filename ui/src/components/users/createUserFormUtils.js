...
export function validateCreateUserForm(formData, { requirePassword = true } = {}) {
  ...
  if (!username) errors.username = 'Please enter a username'
    ...
    errors.username = 'Username must be 3-50 chars and use a-z, 0-9, ., _ or - (no spaces)'
  }
...
export function buildCreateUserPayload(formData, { includePassword = true } = {}) {
  const payload = {
    ...formData,
